package com.megagen.strider.pathing;
...
public class AStar {
	...
	public AStar(Minecraft mc, BlockPos start, BlockPos end, int range) throws InvalidPathException {

		boolean s = true, e = true;

		if (!(s = this.isBlockPosWalkable(start)) || !(e = this.isBlockPosWalkable(end))) {
	...
	private void processAdjacentTiles(Tile current) {
		...
		// set of possible walk to BlockPoss adjacent to current tile
...
//		}
	...
	private boolean isBlockPosWalkable(BlockPos l) {
//		Block b = l.getBlock();
//		int i = b.getTypeId();
//
